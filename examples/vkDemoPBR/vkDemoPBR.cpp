...
public:
	...
	void buildCommandBuffers()
	{
		...
		for (size_t i = 0; i < drawCmdBuffers.size(); ++i)
		{
			...
			for (uint32_t x = 0; x < objcount; x++) {
				...
				mat.params.clearCoatStrength = 1.0f;
				mat.params.clearCoatRoughness = 1.1f - mat.params.roughness;
	...
	void preparePipelines()
	{
		...
		// PBR pipeline
		shaderStages[0] = loadShader(getShadersPath() + "demoPBR/pbrDemo.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "demoPBR/pbrDemo.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
